...
> 📘 **Panduan pengguna (runbook praktis):** [docs/flow/module-payroll-user-flow.md](../flow/module-payroll-user-flow.md) — langkah demi langkah dari setup → proses → distribusi. Versi ringkas dalam seri sub-plan: [09-user-flow.md](09-user-flow.md).

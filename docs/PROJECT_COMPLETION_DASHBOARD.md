...
| **Migration Files** | **86 per dialect** (43 up + 43 down) |
...
| Item | Count | Details |
|------|:----:|---------|
| **Tenant migration files (MySQL)** | **86** (43 up + 43 down) | `001_master_data` → `043_standardize_job_value_uuids` |
| **Tenant migration files (Postgres)** | **86** (43 up + 43 down) | Same as MySQL, dialect-adapted |

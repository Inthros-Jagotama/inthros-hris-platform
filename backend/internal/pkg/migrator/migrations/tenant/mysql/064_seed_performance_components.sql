...
SELECT 'a1b2c3d4-0001-4000-8000-000000000001', 'KPI', 'Indikator', 'Indikator Kinerja Utama (KPI) sesuai template posisi jabatan.', 1, 1, NOW(), NOW()
FROM DUAL
WHERE NOT EXISTS (SELECT 1 FROM performance_components WHERE code = 'KPI');

INSERT INTO performance_components (id, code, name, description, sort_order, is_active, created_at, updated_at)
SELECT 'a1b2c3d4-0002-4000-8000-000000000002', 'PROGRAM', 'Program', 'Program kerja yang diajukan sendiri oleh karyawan pada setiap evaluasi.', 2, 1, NOW(), NOW()
FROM DUAL
WHERE NOT EXISTS (SELECT 1 FROM performance_components WHERE code = 'PROGRAM');

INSERT INTO performance_components (id, code, name, description, sort_order, is_active, created_at, updated_at)
SELECT 'a1b2c3d4-0003-4000-8000-000000000003', 'SUBORDINATE', 'Kinerja Bawahan', 'Dihitung otomatis dari rata-rata skor akhir evaluasi karyawan yang melapor ke posisi ini.', 3, 1, NOW(), NOW()
FROM DUAL

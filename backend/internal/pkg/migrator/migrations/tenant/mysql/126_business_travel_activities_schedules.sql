...
CREATE TABLE IF NOT EXISTS business_travel_activities (
    ...
    INDEX idx_biztrav_act_travel (business_travel_id),
    INDEX idx_biztrav_act_deleted_at (deleted_at)
...
CREATE TABLE IF NOT EXISTS business_travel_schedules (
    ...
    departure_datetime    TIMESTAMP(6) NULL DEFAULT NULL,
    arrival_datetime      TIMESTAMP(6) NULL DEFAULT NULL,
    ...
    created_at            TIMESTAMP(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6),
    updated_at            TIMESTAMP(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6),
    INDEX idx_biztrav_sched_travel (business_travel_id),
    INDEX idx_biztrav_sched_deleted_at (deleted_at)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

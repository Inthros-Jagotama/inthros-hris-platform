...
CREATE INDEX IF NOT EXISTS idx_notification_recipient_unread ON notifications (recipient_user_id, is_read);
CREATE INDEX IF NOT EXISTS idx_notification_reference ON notifications (reference_type, reference_id);

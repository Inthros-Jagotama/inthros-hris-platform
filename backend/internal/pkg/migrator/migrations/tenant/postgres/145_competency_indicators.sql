...
CREATE INDEX IF NOT EXISTS idx_comp_indicator_comp ON competency_indicators (competency_id);

CREATE INDEX IF NOT EXISTS idx_comp_indicator_status ON competency_indicators (status);
...
CREATE TABLE IF NOT EXISTS competency_assessment_template_indicators (
    ...
    CONSTRAINT uk_comp_tpl_indicator UNIQUE (template_id, indicator_id),
...
CREATE INDEX IF NOT EXISTS idx_comp_tpl_ind_indicator ON competency_assessment_template_indicators (indicator_id);

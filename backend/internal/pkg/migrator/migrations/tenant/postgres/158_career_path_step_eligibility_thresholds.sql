-- =============================================================================
-- Tenant Migration: 158_career_path_step_eligibility_thresholds (PostgreSQL)
-- =============================================================================
...
ALTER TABLE career_path_steps
    ADD COLUMN IF NOT EXISTS min_performance_score DECIMAL(5,2) NULL,
    ADD COLUMN IF NOT EXISTS min_competency_score  DECIMAL(5,2) NULL,
    ADD COLUMN IF NOT EXISTS min_okr_score          DECIMAL(5,2) NULL;

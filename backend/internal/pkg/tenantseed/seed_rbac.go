...
func tenantRBACResources() []tenantRBACResource {
	...
	return []tenantRBACResource{
		...
		{"setting", std, []tenantRBACSubmenu{
			...
			{"numbering", std},
			{"performance-perspectives", std},
			{"performance-ratings", std},
			{"performance-formulas", std},
			{"performance-components", std},
			{"performance-scoring", std},
			{"payroll-periods", std},
			{"salary-components", std},
			{"bpjs-settings", std},
			{"pph21-settings", std},
			{"salary-structure", std},
		}},

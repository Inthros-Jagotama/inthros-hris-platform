...
func (h *Handler) DeleteZone(c *gin.Context) {
	if err := h.service.DeleteZone(c.Request.Context(), c.Param("id")); err != nil { httputil.ErrorSimple(c, http.StatusInternalServerError, err.Error()); return }
...
func (h *Handler) DeleteProvince(c *gin.Context) {
	if err := h.service.DeleteProvince(c.Request.Context(), c.Param("id")); err != nil { httputil.ErrorSimple(c, http.StatusInternalServerError, err.Error()); return }
	httputil.DeletedJSON(c, "success.deleted")
}
...
func (h *Handler) DeleteRegency(c *gin.Context) {
	if err := h.service.DeleteRegency(c.Request.Context(), c.Param("id")); err != nil { httputil.ErrorSimple(c, http.StatusInternalServerError, err.Error()); return }
	httputil.DeletedJSON(c, "success.deleted")
}
...
func (h *Handler) DeleteDistrict(c *gin.Context) {
	if err := h.service.DeleteDistrict(c.Request.Context(), c.Param("id")); err != nil { httputil.ErrorSimple(c, http.StatusInternalServerError, err.Error()); return }
	httputil.DeletedJSON(c, "success.deleted")
}
...
func (h *Handler) DeleteEducation(c *gin.Context) {
	if err := h.service.DeleteEducation(c.Request.Context(), c.Param("id")); err != nil { httputil.ErrorSimple(c, http.StatusInternalServerError, err.Error()); return }
	httputil.DeletedJSON(c, "success.deleted")
}
...
func (h *Handler) DeleteReligion(c *gin.Context) {
	if err := h.service.DeleteReligion(c.Request.Context(), c.Param("id")); err != nil { httputil.ErrorSimple(c, http.StatusInternalServerError, err.Error()); return }
	httputil.DeletedJSON(c, "success.deleted")
}
...
func (h *Handler) DeleteMaritalStatus(c *gin.Context) {
	if err := h.service.DeleteMaritalStatus(c.Request.Context(), c.Param("id")); err != nil { httputil.ErrorSimple(c, http.StatusInternalServerError, err.Error()); return }
	httputil.DeletedJSON(c, "success.deleted")
}
...
func (h *Handler) DeleteRelationshipType(c *gin.Context) {
	if err := h.service.DeleteRelationshipType(c.Request.Context(), c.Param("id")); err != nil { httputil.ErrorSimple(c, http.StatusInternalServerError, err.Error()); return }
	httputil.DeletedJSON(c, "success.deleted")
}
...
func (h *Handler) DeleteEmploymentStatus(c *gin.Context) {
	if err := h.service.DeleteEmploymentStatus(c.Request.Context(), c.Param("id")); err != nil { httputil.ErrorSimple(c, http.StatusInternalServerError, err.Error()); return }
	httputil.DeletedJSON(c, "success.deleted")
}
...
func (h *Handler) DeleteBank(c *gin.Context) {
	if err := h.service.DeleteBank(c.Request.Context(), c.Param("id")); err != nil { httputil.ErrorSimple(c, http.StatusInternalServerError, err.Error()); return }
	httputil.DeletedJSON(c, "success.deleted")
}
...
func (h *Handler) DeleteNationality(c *gin.Context) {
	if err := h.service.DeleteNationality(c.Request.Context(), c.Param("id")); err != nil { httputil.ErrorSimple(c, http.StatusInternalServerError, err.Error()); return }
	httputil.DeletedJSON(c, "success.deleted")
}
...
func (h *Handler) DeleteJobFamily(c *gin.Context) {
	if err := h.service.DeleteJobFamily(c.Request.Context(), c.Param("id")); err != nil { httputil.ErrorSimple(c, http.StatusInternalServerError, err.Error()); return }
	httputil.DeletedJSON(c, "success.deleted")
}
...
func (h *Handler) DeleteSalaryGrade(c *gin.Context) {
	if err := h.service.DeleteSalaryGrade(c.Request.Context(), c.Param("id")); err != nil { httputil.ErrorSimple(c, http.StatusInternalServerError, err.Error()); return }
	httputil.DeletedJSON(c, "success.deleted")
}

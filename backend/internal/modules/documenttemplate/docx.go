...
func sampleData() map[string]string {
	return map[string]string{
		...
		"employee.join_date":         "1 Juni 2018",
		"employee.position":          "HR Staff",
		"employee.organization":      "HR Division",
		"contract.number":            "CTR-2026-001",
		"contract.type":              "PKWT",
		"contract.start_date":        "1 Januari 2026",
		"contract.end_date":          "1 Januari 2027",
		"movement.number":            "SK-MOV-2026-001",
		"movement.effective_date":    "15 Januari 2026",

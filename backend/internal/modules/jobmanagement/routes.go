...
func RegisterRoutes(rg *gin.RouterGroup, handler *Handler) {
	...
	values := rg.Group("/job-management/values")
	{
		...
		// Mapping type ↔ cluster kompetensi (diatur di halaman Mapping Job Value)
		values.GET("/clusters/:type", handler.ListJobValueClusters)
		values.PUT("/clusters/:type", handler.UpdateJobValueClusters)

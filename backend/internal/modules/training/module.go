		...
		Menus: []module.Menu{
			{
				...
				Children: []module.Menu{
					...
					{Name: "Planning", Icon: "calendar-plus", Route: "/training/plans"},
					{Name: "Requests", Icon: "send", Route: "/training/requests"},
					{Name: "Needs", Icon: "target", Route: "/training/needs"},
					{Name: "Certificates", Icon: "award", Route: "/training/certificates"},
					{Name: "History", Icon: "history", Route: "/training/history"},
					{Name: "Reports", Icon: "chart-bar", Route: "/training/reports"},
					// Evaluasi diakses via tab di Session Detail (bukan halaman terpisah).
				},
			},
		},
	}

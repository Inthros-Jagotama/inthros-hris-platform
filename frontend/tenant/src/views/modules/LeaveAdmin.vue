...
const items = [
  { path: '/leave/types', icon: 'pi pi-tags', titleKey: 'leave.types', descKey: 'leave.types_description' },
  { path: '/leave/accrual-policies', icon: 'pi pi-percentage', titleKey: 'leave.accrual_policies', descKey: 'leave.accrual_policies_description' },
  { path: '/leave/reasons', icon: 'pi pi-list', titleKey: 'leave.reasons', descKey: 'leave.reasons_description' }
]
</script>

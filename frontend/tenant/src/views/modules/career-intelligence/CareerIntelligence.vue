...
const menuCards = computed(() => [
  ...
  { labelKey: 'gap_analysis.title', descKey: 'gap_analysis.description', icon: 'pi pi-sitemap', tint: 'bg-sky-50 dark:bg-sky-500/10 text-sky-600 dark:text-sky-400', route: '/career-intelligence/gap-analysis', permission: 'career-intelligence.gap-analysis.view' },

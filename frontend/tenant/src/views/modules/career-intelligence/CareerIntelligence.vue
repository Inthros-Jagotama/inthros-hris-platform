...
const menuCards = computed(() => [
  ...
  { labelKey: 'career_intel.succession_plans', descKey: 'succession_plans.description', icon: 'pi pi-user-plus', tint: 'bg-rose-50 dark:bg-rose-500/10 text-rose-600 dark:text-rose-400', route: '/career-intelligence/succession-plans', permission: 'career-intelligence.succession.view' },

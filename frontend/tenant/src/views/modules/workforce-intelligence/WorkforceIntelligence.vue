...
const menuCards = computed(() => [
  ...
  { labelKey: 'risk_dashboard.title', descKey: 'risk_dashboard.description', icon: 'pi pi-exclamation-triangle', tint: 'bg-rose-50 dark:bg-rose-500/10 text-rose-600 dark:text-rose-400', route: '/workforce-intelligence/risk-dashboard', permission: 'workforceintelligence.risk-dashboard.view' },

...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'settings/numbering', name: 'SettingsNumbering', component: () => import('@/views/settings/NumberingSettingsView.vue'), meta: { title: 'Document Numbering', titleKey: 'numbering_settings.title', descKey: 'numbering_settings.title', icon: 'pi pi-hashtag', module: 'setting' } },

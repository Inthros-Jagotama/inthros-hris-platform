  ...
  },
  {
    ...
    children: [
      ...
      // Organization Summary (masuk via menu Organization)
      {
        ...
        meta: { title: 'Organization', titleKey: 'organization.title', descKey: 'org_summary.description', icon: 'pi pi-building', module: 'organization', permission: 'organization.view' }
      },
      // Organization Management
      {
        ...
        meta: { title: 'Organization', titleKey: 'organization.title', descKey: 'organization.description', icon: 'pi pi-sitemap', module: 'organization', permission: 'organization.tree.view' }
      },
      // Employee Management
      {
        path: 'employees',
        ...
        meta: { title: 'Employees', titleKey: 'employee.title', descKey: 'employee.description', icon: 'pi pi-users', module: 'employee', permission: 'employee.view' }
      },
      {
        path: 'employees/new',
        name: 'EmployeeNew',
        component: () => import('@/views/modules/employee/EmployeeForm.vue'),
        meta: { title: 'New Employee', titleKey: 'employee.new', descKey: 'employee.description', icon: 'pi pi-user-plus', module: 'employee', backRoute: '/employees', backLabelKey: 'nav.employees', permission: 'employee.create' }
      },
      {
        path: 'employees/:id',
        name: 'EmployeeDetail',
        component: () => import('@/views/modules/employee/EmployeeDetail.vue'),
        meta: { title: 'View Employee', titleKey: 'employee.view', descKey: 'employee.description', icon: 'pi pi-eye', module: 'employee', backRoute: '/employees', backLabelKey: 'nav.employees', permission: 'employee.view' }
      },
      {
        path: 'employees/:id/edit',
        name: 'EmployeeEdit',
        component: () => import('@/views/modules/employee/EmployeeForm.vue'),
        meta: { title: 'Edit Employee', titleKey: 'employee.edit', descKey: 'employee.description', icon: 'pi pi-user-edit', module: 'employee', backRoute: '/employees', backLabelKey: 'nav.employees', permission: 'employee.update' }
      },
      // Job Management
      {
        path: 'job-management',
        ...
        meta: { title: 'Job Management', titleKey: 'job_management.title', descKey: 'job_management.page_description', icon: 'pi pi-briefcase', module: 'jobmanagement', permission: 'jobmanagement.view' }
      },
      {
      ...
      },
      {
        ...
        meta: { title: 'Manage Job Data', titleKey: 'job_management.manage', descKey: 'job_management.manage_description', icon: 'pi pi-briefcase', module: 'jobmanagement', backRoute: '/job-management', backLabelKey: 'nav.job_management', permission: 'jobmanagement.view' }
      },
      ...
      },
      {
        ...
        meta: { title: 'Rating Scales', titleKey: 'competency_360.rating_scales', descKey: 'competency_360.rating_scales_desc', icon: 'pi pi-sliders-h', module: 'competency', backRoute: '/competencies', backLabelKey: 'nav.competency', permission: 'competency.values.view' }
      },
      {
        path: 'competencies/indicators',
        name: 'CompetencyIndicators',
        component: () => import('@/views/modules/competency/CompetencyIndicators.vue'),
        meta: { title: 'Indicators', titleKey: 'competency_360.indicators', descKey: 'competency_360.indicators_desc', icon: 'pi pi-list', module: 'competency', backRoute: '/competencies', backLabelKey: 'nav.competency', permission: 'competency.indicators.view' }
      },
      {
        path: 'competencies/templates',
        name: 'AssessmentTemplates',
        component: () => import('@/views/modules/competency/AssessmentTemplates.vue'),
        meta: { title: 'Assessment Templates', titleKey: 'competency_360.templates', descKey: 'competency_360.templates_desc', icon: 'pi pi-clone', module: 'competency', backRoute: '/competencies', backLabelKey: 'nav.competency', permission: 'competency.templates.view' }
      },
      {
        ...
        meta: { title: 'New Assessment Template', titleKey: 'competency_360.new_template', descKey: 'competency_360.templates_desc', icon: 'pi pi-clone', module: 'competency', backRoute: '/competencies/templates', backLabelKey: 'competency_360.templates', permission: 'competency.templates.view' }
      },
      {
        path: 'competencies/templates/:id/edit',
        name: 'AssessmentTemplateEdit',
        component: () => import('@/views/modules/competency/AssessmentTemplateForm.vue'),
        meta: { title: 'Edit Assessment Template', titleKey: 'competency_360.edit_template', descKey: 'competency_360.templates_desc', icon: 'pi pi-clone', module: 'competency', backRoute: '/competencies/templates', backLabelKey: 'competency_360.templates', permission: 'competency.templates.view' }
      },
      {
        path: 'competencies/events',
        name: 'CompetencyEvents',
        component: () => import('@/views/modules/competency/CompetencyEvents.vue'),
        meta: { title: 'Competency Events', titleKey: 'competency_360.events', descKey: 'competency_360.events_desc', icon: 'pi pi-calendar', module: 'competency', backRoute: '/competencies', backLabelKey: 'nav.competency', permission: 'competency.events.view' }
      },
      {
        path: 'competencies/raters',
        name: 'RaterAssignment',
        component: () => import('@/views/modules/competency/RaterAssignment.vue'),
        meta: { title: 'Rater Assignment', titleKey: 'competency_360.rater_assignment', descKey: 'competency_360.rater_assignment_desc', icon: 'pi pi-users', module: 'competency', backRoute: '/competencies', backLabelKey: 'nav.competency', permission: 'competency.raters.view' }
      },
      {
        path: 'competencies/my-assessments',
        name: 'MyAssessments',
        component: () => import('@/views/modules/competency/MyAssessments.vue'),
        meta: { title: 'My Assessment', titleKey: 'competency_360.my_assessments', descKey: 'competency_360.my_assessments_desc', icon: 'pi pi-list-check', module: 'competency', backRoute: '/competencies', backLabelKey: 'nav.competency', permission: 'competency.my-assessments.view' }
      },
      {
        ...
        meta: { title: 'Manager Assessment', titleKey: 'competency_360.manager_assessments', descKey: 'competency_360.manager_assessments_desc', icon: 'pi pi-user-edit', module: 'competency', backRoute: '/competencies', backLabelKey: 'nav.competency', permission: 'competency.manager-assessments.view' }
      },
      {
        path: 'competencies/results',
        name: 'AssessmentResult',
        component: () => import('@/views/modules/competency/AssessmentResult.vue'),
        meta: { title: 'Assessment Result', titleKey: 'competency_360.results', descKey: 'competency_360.results_desc', icon: 'pi pi-chart-bar', module: 'competency', backRoute: '/competencies', backLabelKey: 'nav.competency', permission: 'competency.results.view' }
      },
      {
        path: 'competencies/reports',
        name: 'CompetencyReports',
        component: () => import('@/views/modules/competency/CompetencyReports.vue'),
        meta: { title: 'Competency Reports', titleKey: 'competency_360.reports', descKey: 'competency_360.reports_desc', icon: 'pi pi-file-chart', module: 'competency', backRoute: '/competencies', backLabelKey: 'nav.competency', permission: 'competency.reports.view' }
      },
      // Employee Movement & Career Management (G-8: route menyamakan menu server)
      {
        ...
        meta: { title: 'Movements', titleKey: 'employee_movement.movements', descKey: 'employee_movement.description', icon: 'pi pi-arrows-alt', module: 'employeemovement', backRoute: '/admin/career/reports', backLabelKey: 'employee_movement.movements_contracts', permission: 'employeemovement.movements.view' }
      },
      {
        path: 'admin/career/contracts',
        name: 'EmployeeContracts',
        component: () => import('@/views/modules/employeemovement/EmployeeContracts.vue'),
        meta: { title: 'Contracts', titleKey: 'employee_movement.contracts', descKey: 'employee_movement.description', icon: 'pi pi-file-edit', module: 'employeemovement', backRoute: '/admin/career/reports', backLabelKey: 'employee_movement.movements_contracts', permission: 'employeemovement.contracts.view' }
      },
      {
        ...
        meta: { title: 'Movements & Contracts', titleKey: 'employee_movement.movements_contracts', descKey: 'employee_movement.reports_description', icon: 'pi pi-chart-bar', module: 'employeemovement', permission: 'employeemovement.view' }
      },
      {
        path: 'career-intelligence/paths',
        name: 'CareerPaths',
        component: () => import('@/views/modules/career-intelligence/CareerPaths.vue'),
        meta: { title: 'Career Paths', titleKey: 'career_paths.title', descKey: 'career_paths.description', icon: 'pi pi-sitemap', module: 'career-intelligence', backRoute: '/career-intelligence', backLabelKey: 'career_intel.title', permission: 'careerintelligence.paths.view' }
      },
      // Time & Attendance
      {
        path: 'attendance',
      ...
      // Approval Engine
      {
        ...
        meta: { title: 'Approval', titleKey: 'approval.title', descKey: 'approval.description', icon: 'pi pi-check-square', module: 'approval', permission: 'approval.view' }
      },
      {
      ...
      // Notifications
      {
        ...
        meta: { title: 'Notifications', titleKey: 'notification.title', descKey: 'notification.description', icon: 'pi pi-bell', module: 'notification', permission: 'notification.view' }
      },
      // Payroll
      {
        path: 'payroll',
        ...
        meta: { title: 'Payroll', titleKey: 'payroll.title', descKey: 'payroll.description', icon: 'pi pi-dollar', module: 'payroll', permission: 'payroll.view' }
      },
      {
        path: 'payroll/runs/:id',
        name: 'PayrollRunDetail',
        component: () => import('@/views/modules/payroll/PayrollRunDetail.vue'),
        meta: { title: 'Run Detail', titleKey: 'payroll.run_detail', descKey: 'payroll.description', icon: 'pi pi-dollar', module: 'payroll', backRoute: '/payroll', backLabelKey: 'payroll.payroll_runs', permission: 'payroll.runs.view' }
      },
      // Leave & Time Off
      {
        path: 'leave',
      ...
      },
      {
        ...
        meta: { title: 'Leave Types', titleKey: 'leave.types', descKey: 'leave.types_description', icon: 'pi pi-tags', module: 'leave', backRoute: '/leave/admin', backLabelKey: 'leave.admin', permission: 'leave.types.view' }
      },
      {
        path: 'leave/accrual-policies',
        name: 'LeaveAccrualPolicies',
        component: () => import('@/views/modules/leave/LeaveAccrualPolicies.vue'),
        meta: { title: 'Accrual Policies', titleKey: 'leave.accrual_policies', descKey: 'leave.accrual_policies_description', icon: 'pi pi-percentage', module: 'leave', backRoute: '/leave/admin', backLabelKey: 'leave.admin', permission: 'leave.accrual-policies.view' }
      },
      {
        path: 'leave/reasons',
        name: 'LeaveReasons',
        component: () => import('@/views/modules/leave/LeaveReasons.vue'),
        meta: { title: 'Leave Reasons', titleKey: 'leave.reasons', descKey: 'leave.reasons_description', icon: 'pi pi-list', module: 'leave', backRoute: '/leave/admin', backLabelKey: 'leave.admin', permission: 'leave.reasons.view' }
      },
      ...
      // Onboarding — G-4: employee hasil offer (recruited_from_application_id) + status (S-7 handoff)
      {
        ...
        meta: { title: 'Onboarding', titleKey: 'recruitment.onboarding', descKey: 'onboarding.description', icon: 'pi pi-rocket', module: 'recruitment', backRoute: '/recruitment', backLabelKey: 'recruitment.title', permission: 'recruitment.onboarding.view' }
      },
      // Reimbursement — index page (menu cards + summary)
      {
        ...
        meta: { title: 'Reimbursement', titleKey: 'reimbursement.title', descKey: 'reimbursement.description', icon: 'pi pi-credit-card', module: 'reimbursement', permission: 'reimbursement.view' }
      },
      {
      ...
      },
      {
        ...
        component: () => import('@/views/modules/reimbursement/ReimbursementRequests.vue'),
        meta: { title: 'My Reimbursement Requests', titleKey: 'reimbursement.my_requests', descKey: 'reimbursement.description', icon: 'pi pi-credit-card', module: 'reimbursement', backRoute: '/reimbursements', backLabelKey: 'reimbursement.title', permission: 'reimbursement.requests.view' }
      },
      {
      ...
      },
      {
        ...
        meta: { title: 'View Reimbursement Request', titleKey: 'reimbursement.view', descKey: 'reimbursement.description', icon: 'pi pi-eye', module: 'reimbursement', backRoute: '/reimbursements', backLabelKey: 'reimbursement.title', permission: 'reimbursement.requests.view' }
      },
      ...
      // Candidate Search — posisi kosong + kandidat recruitment
      {
        ...
        meta: { title: 'Candidate Search', titleKey: 'candidate_search.title', descKey: 'candidate_search.description', icon: 'pi pi-user-plus', module: 'workforce-intelligence', backRoute: '/workforce-intelligence', backLabelKey: 'workforce_intel.title', permission: 'workforceintelligence.candidate-search.view' }
      },
      // Quality of Hire — metrik agregat kualitas hire (S-6)
      {
        ...
        meta: { title: 'Quality of Hire', titleKey: 'quality_of_hire.title', descKey: 'quality_of_hire.description', icon: 'pi pi-bullseye', module: 'workforce-intelligence', backRoute: '/workforce-intelligence', backLabelKey: 'workforce_intel.title', permission: 'workforceintelligence.quality-of-hire.view' }
      },
      // Recruitment Analytics — S-2 (remaining gap, expected hires) + S-3 (time to hire/fill, OAR, source conversion)
      {
        ...
        meta: { title: 'Recruitment Analytics', titleKey: 'recruitment_analytics.title', descKey: 'recruitment_analytics.description', icon: 'pi pi-chart-line', module: 'workforce-intelligence', backRoute: '/workforce-intelligence', backLabelKey: 'workforce_intel.title', permission: 'workforceintelligence.recruitment-analytics.view' }
      },
      // Career Intelligence
      {
      ...
      { path: 'settings/provinces', name: 'SettingsProvinces', component: () => import('@/views/settings/ProvincesView.vue'), meta: { title: 'Provinces', titleKey: 'provinces.title', descKey: 'provinces.description', icon: 'pi pi-globe', module: 'setting', permission: 'setting.provinces.view' } },
      { path: 'settings/regencies', name: 'SettingsRegencies', component: () => import('@/views/settings/RegenciesView.vue'), meta: { title: 'Regencies', titleKey: 'regencies.title', descKey: 'regencies.description', icon: 'pi pi-map', module: 'setting', permission: 'setting.regencies.view' } },
      { path: 'settings/districts', name: 'SettingsDistricts', component: () => import('@/views/settings/DistrictsView.vue'), meta: { title: 'Districts', titleKey: 'districts.title', descKey: 'districts.description', icon: 'pi pi-building', module: 'setting', permission: 'setting.districts.view' } },
      { path: 'settings/villages', name: 'SettingsVillages', component: () => import('@/views/settings/VillagesView.vue'), meta: { title: 'Villages', titleKey: 'villages.title', descKey: 'villages.description', icon: 'pi pi-home', module: 'setting', permission: 'setting.villages.view' } },
      { path: 'settings/educations', name: 'SettingsEducations', component: () => import('@/views/settings/EducationsView.vue'), meta: { title: 'Educations', titleKey: 'educations.title', descKey: 'educations.description', icon: 'pi pi-graduation-cap', module: 'setting', permission: 'setting.educations.view' } },
      { path: 'settings/education-majors', name: 'SettingsEducationMajors', component: () => import('@/views/settings/EducationMajorsView.vue'), meta: { title: 'Education Majors', titleKey: 'education_majors.title', descKey: 'education_majors.description', icon: 'pi pi-graduation-cap', module: 'setting', permission: 'setting.education-majors.view' } },
      { path: 'settings/religions', name: 'SettingsReligions', component: () => import('@/views/settings/ReligionsView.vue'), meta: { title: 'Religions', titleKey: 'religions.title', descKey: 'religions.description', icon: 'pi pi-globe', module: 'setting', permission: 'setting.religions.view' } },
      { path: 'settings/marital-statuses', name: 'SettingsMaritalStatuses', component: () => import('@/views/settings/MaritalStatusesView.vue'), meta: { title: 'Marital Statuses', titleKey: 'marital_status.title', descKey: 'marital_status.description', icon: 'pi pi-heart', module: 'setting', permission: 'setting.marital-statuses.view' } },
      { path: 'settings/relationship-types', name: 'SettingsRelationshipTypes', component: () => import('@/views/settings/RelationshipTypesView.vue'), meta: { title: 'Relationship Types', titleKey: 'relationship_types.title', descKey: 'relationship_types.description', icon: 'pi pi-users', module: 'setting', permission: 'setting.relationship-types.view' } },
      { path: 'settings/banks', name: 'SettingsBanks', component: () => import('@/views/settings/BanksView.vue'), meta: { title: 'Banks', titleKey: 'banks.title', descKey: 'banks.description', icon: 'pi pi-home', module: 'setting', permission: 'setting.banks.view' } },
      { path: 'settings/employment-statuses', name: 'SettingsEmploymentStatuses', component: () => import('@/views/settings/EmploymentStatusesView.vue'), meta: { title: 'Employment Statuses', titleKey: 'employment_statuses.title', descKey: 'employment_statuses.description', icon: 'pi pi-briefcase', module: 'setting', permission: 'setting.employment-statuses.view' } },
      { path: 'settings/nationalities', name: 'SettingsNationalities', component: () => import('@/views/settings/NationalitiesView.vue'), meta: { title: 'Nationalities', titleKey: 'nationalities.title', descKey: 'nationalities.description', icon: 'pi pi-globe', module: 'setting', permission: 'setting.nationalities.view' } },
      { path: 'settings/job-families', name: 'SettingsJobFamilies', component: () => import('@/views/settings/JobFamiliesView.vue'), meta: { title: 'Job Families', titleKey: 'job_families.title', descKey: 'job_families.description', icon: 'pi pi-briefcase', module: 'setting', permission: 'setting.job-families.view' } },
      { path: 'settings/gradings', name: 'SettingsGradings', component: () => import('@/views/settings/GradingsView.vue'), meta: { title: 'Gradings', titleKey: 'gradings.title', descKey: 'gradings.description', icon: 'pi pi-chart-bar', module: 'setting', permission: 'setting.gradings.view' } },
      { path: 'settings/salary-grades', name: 'SettingsSalaryGrades', component: () => import('@/views/settings/SalaryGradesView.vue'), meta: { title: 'Salary Grades', titleKey: 'salary_grades.title', descKey: 'salary_grades.description', icon: 'pi pi-chart-bar', module: 'setting', permission: 'setting.salary-grades.view' } },
      { path: 'settings/insurances', name: 'SettingsInsurances', component: () => import('@/views/settings/InsurancesView.vue'), meta: { title: 'Insurances', titleKey: 'insurances.title', descKey: 'insurances.description', icon: 'pi pi-shield', module: 'setting', permission: 'setting.insurances.view' } },
      { path: 'settings/company-holidays', name: 'SettingsCompanyHolidays', component: () => import('@/views/settings/CompanyHolidaysView.vue'), meta: { title: 'Company Holidays', titleKey: 'company_holidays.title', descKey: 'company_holidays.description', icon: 'pi pi-calendar', module: 'setting', permission: 'setting.company-holidays.view' } },
      { path: 'settings/numbering', name: 'SettingsNumbering', component: () => import('@/views/settings/NumberingSettingsView.vue'), meta: { title: 'Document Numbering', titleKey: 'numbering_settings.title', descKey: 'numbering_settings.description', icon: 'pi pi-hashtag', module: 'setting', permission: 'setting.numbering.view' } },
      { path: 'settings/document-templates', name: 'SettingsDocumentTemplates', component: () => import('@/views/settings/DocumentTemplatesView.vue'), meta: { title: 'Document Templates', titleKey: 'document_templates.title', descKey: 'document_templates.description', icon: 'pi pi-file-edit', module: 'setting', permission: 'setting.document-templates.view' } },
      { path: 'settings/document-templates/new', name: 'SettingsDocumentTemplateNew', component: () => import('@/views/settings/DocumentTemplateForm.vue'), meta: { title: 'New Document Template', titleKey: 'document_templates.new', descKey: 'document_templates.description', icon: 'pi pi-plus', module: 'setting', backRoute: '/settings/document-templates', backLabelKey: 'document_templates.title', permission: 'setting.document-templates.view' } },
      ...
      { path: 'settings/competencies', name: 'SettingsCompetencies', component: () => import('@/views/settings/CompetenciesView.vue'), meta: { title: 'Competencies', titleKey: 'competencies.title', descKey: 'competencies.description', icon: 'pi pi-star', module: 'setting', permission: 'setting.competencies.view' } },
      { path: 'settings/salary-components', name: 'SettingsSalaryComponents', component: () => import('@/views/settings/SalaryComponentsView.vue'), meta: { title: 'Salary Components', titleKey: 'payroll.salary_components', descKey: 'payroll.salary_components_desc', icon: 'pi pi-list', module: 'payroll', permission: 'payroll.salary-components.view' } },
      { path: 'settings/payroll-periods', name: 'SettingsPayrollPeriods', component: () => import('@/views/settings/PayrollPeriodsView.vue'), meta: { title: 'Payroll Periods', titleKey: 'payroll.payroll_periods', descKey: 'payroll.payroll_periods_desc', icon: 'pi pi-calendar', module: 'payroll', permission: 'payroll.periods.view' } },
      { path: 'settings/bpjs-settings', name: 'SettingsBpjsSettings', component: () => import('@/views/settings/BpjsSettingsView.vue'), meta: { title: 'BPJS Settings', titleKey: 'payroll.bpjs', descKey: 'payroll.bpjs_desc', icon: 'pi pi-shield', module: 'payroll', permission: 'payroll.bpjs-settings.view' } },
      { path: 'settings/pph21-settings', name: 'SettingsPph21Settings', component: () => import('@/views/settings/Pph21SettingsView.vue'), meta: { title: 'PPh21 Settings', titleKey: 'payroll.pph21', descKey: 'payroll.pph21_desc', icon: 'pi pi-percentage', module: 'payroll', permission: 'payroll.pph21-settings.view' } },
      { path: 'settings/salary-structure', name: 'SettingsSalaryStructure', component: () => import('@/views/settings/SalaryStructureView.vue'), meta: { title: 'Salary Structure', titleKey: 'payroll.salary_structure', descKey: 'payroll.salary_structure_desc', icon: 'pi pi-sitemap', module: 'payroll', permission: 'payroll.profiles.view' } },
      ...
      { path: 'settings/sensitive-fields', name: 'SettingsSensitiveFields', component: () => import('@/views/settings/SensitiveFieldSettings.vue'), meta: { title: 'Sensitive Data Settings', titleKey: 'sensitive_field.title', descKey: 'sensitive_field.description', icon: 'pi pi-lock', module: 'setting', permission: 'setting.sensitive-fields.view' } },
...
router.beforeEach(async (to, from, next) => {
  ...
  // Check permission for routes with meta.permission

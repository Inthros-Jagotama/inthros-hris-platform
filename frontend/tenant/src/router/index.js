...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'settings/employee-id-format', name: 'SettingsEmployeeIdFormat', component: () => import('@/views/settings/EmployeeIdFormatSettingsView.vue'), meta: { title: 'Employee ID Format', titleKey: 'employee_id_format.title', descKey: 'employee_id_format.description', icon: 'pi pi-id-card', module: 'setting', permission: 'setting.employee_id_format.view' } },

  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        meta: { title: 'Run Detail', titleKey: 'payroll.run_detail', descKey: 'payroll.description', icon: 'pi pi-dollar', module: 'payroll', backRoute: '/payroll', backLabelKey: 'payroll.payroll_runs', permission: 'payroll.view' }
      },
      // Leave & Time Off
      {
        path: 'leave',
      ...
      { path: 'settings/salary-components', name: 'SettingsSalaryComponents', component: () => import('@/views/settings/SalaryComponentsView.vue'), meta: { title: 'Salary Components', titleKey: 'payroll.salary_components', descKey: 'payroll.salary_components_desc', icon: 'pi pi-list', module: 'payroll', permission: 'setting.view' } },
      { path: 'settings/payroll-periods', name: 'SettingsPayrollPeriods', component: () => import('@/views/settings/PayrollPeriodsView.vue'), meta: { title: 'Payroll Periods', titleKey: 'payroll.payroll_periods', descKey: 'payroll.payroll_periods_desc', icon: 'pi pi-calendar', module: 'payroll', permission: 'setting.view' } },
      { path: 'settings/bpjs-settings', name: 'SettingsBpjsSettings', component: () => import('@/views/settings/BpjsSettingsView.vue'), meta: { title: 'BPJS Settings', titleKey: 'payroll.bpjs', descKey: 'payroll.bpjs_desc', icon: 'pi pi-shield', module: 'payroll', permission: 'setting.view' } },
      { path: 'settings/pph21-settings', name: 'SettingsPph21Settings', component: () => import('@/views/settings/Pph21SettingsView.vue'), meta: { title: 'PPh21 Settings', titleKey: 'payroll.pph21', descKey: 'payroll.pph21_desc', icon: 'pi pi-percentage', module: 'payroll', permission: 'setting.view' } },
      { path: 'settings/salary-structure', name: 'SettingsSalaryStructure', component: () => import('@/views/settings/SalaryStructureView.vue'), meta: { title: 'Salary Structure', titleKey: 'payroll.salary_structure', descKey: 'payroll.salary_structure_desc', icon: 'pi pi-sitemap', module: 'payroll', permission: 'setting.view' } },

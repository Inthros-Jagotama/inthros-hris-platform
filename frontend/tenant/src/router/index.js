...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'settings/sensitive-fields', name: 'SettingsSensitiveFields', component: () => import('@/views/settings/SensitiveFieldSettings.vue'), meta: { title: 'Sensitive Data Settings', titleKey: 'sensitive_field.title', descKey: 'sensitive_field.description', icon: 'pi pi-lock', module: 'setting', permission: 'employee.view' } },
